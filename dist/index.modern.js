import React, { useRef, useState, useLayoutEffect, useEffect, useContext, useMemo, createContext as createContext$1 } from 'react';
import { not, map, keys, reject, converge, divide, sum, length, last, head } from 'ramda';
import { atom, selector, useSetRecoilState, useRecoilState, useRecoilValue, RecoilRoot } from 'recoil';
...
const isPaused = status => status === PLAYBACK_STATUS.PAUSED;
const isReady = status => status === PLAYBACK_STATUS.READY;
const isActive = status => isPlaying(status) || isPaused(status) || isReady(status);
const isNotActive = status => not(isActive(status));
...
const stopAll = map(track => track.stop());
...
const isLoopedState = atom({
  key: 'isLoopedState',
  default: false
});
const masterVolumeState = atom({
  key: 'masterVolumeState',
  default: 0
});
const progressBarSelector = selector({
...
const FaderThumb = ({
  ...
  }, events)), isKnobThumb && /*#__PURE__*/React.createElement("div", {
...
const Fader = ({
  ...
  }, /*#__PURE__*/React.createElement(FaderThumb, {
    position: value,
    events: {
...
const isContextRunning = context => context.state === CONTEXT_STATE.RUNNING;
...
const MxContext = /*#__PURE__*/React.createContext({
  mx: null,
  isReady: false,
  mixerChanges: null,
  onUserInput: event => {
...
const MxContextProvider = ({
  ...
  return /*#__PURE__*/React.createElement(MxContext.Provider, {
    value: {
      mx,
      isReady,
      mixerChanges,
...
const ProgressBar = () => {
  ...
  const {
    currentPosition,
    duration
  } = useRecoilValue(progressBarSelector);
  ...
  }, convertTime(currentPosition)), /*#__PURE__*/React.createElement("div", {
    className: style.progressTime
  }, convertTime(duration)));
};

var ProgressBar$1 = /*#__PURE__*/React.memo(ProgressBar);
...
const PlayController = ({
  ...
  }, /*#__PURE__*/React.createElement("span", null, "15"), /*#__PURE__*/React.createElement("svg", {
  ...
  }))), !isPlaying(status) ? /*#__PURE__*/React.createElement("button", {
...
const VolumeController = ({
  ...
  }, volumeIcon), /*#__PURE__*/React.createElement(Fader, {
...
const getAverage = converge(divide, [sum, length]);
...
const Context = /*#__PURE__*/createContext$1(null);
...
class FX {
  ...
  addNode(node, parameters = {}) {
    ...
    this.isChainEmpty ? connectNodes(this.signalIn, node) : connectNodesSingle(last(this.chain), node);
...
const Mixer$1 = ({
  ...
  return /*#__PURE__*/React.createElement(MxContextProvider, {
    mx: mx,
    isReady: isReady,
    mixerChanges: mixerChanges,
    onUserInput: onUserInput
  }, /*#__PURE__*/React.createElement(DeskContainer, {
    stopAudio: stopAudio
  }, children && children));
};

const Mixdesk = props => /*#__PURE__*/React.createElement(RecoilRoot, null, /*#__PURE__*/React.createElement(Mixer$1, Object.assign({}, props)));
...
const DeskContainer = ({
  ...
  const onSetMasterVolume = function (value) {
    try {
      ...
      onUserInput({
        type: UserInputEvents.masterVolumeChange,
        value: value
      });
      return Promise.resolve();
    } catch (e) {
  ...
  return /*#__PURE__*/React.createElement(Desk, {
    onPlay: onPlay,
    onPause: onPause,
    onLoop: onLoop,
...
}, values && values.map(value => /*#__PURE__*/React.createElement("div", {
  key: value,
...
const EffectParameter = ({
  ...
  }, /*#__PURE__*/React.createElement(Control, Object.assign({}, props, {
...
const Effect = ({
  ...
  }, name), parameters && parameters.map(parameter => /*#__PURE__*/React.createElement("div", {
    className: style$6.parameterValue,
    key: parameter.id
  }, /*#__PURE__*/React.createElement(EffectParameter, Object.assign({}, parameter, {
...
const EffectContainer = props => {
  ...
  return /*#__PURE__*/React.createElement(Effect, Object.assign({}, props, {
...
const Track$1 = props => {
  ...
  }, (!props.hasSolo || props.isSolo) && /*#__PURE__*/React.createElement("div", {
    className: style$3.meterValue,
    ref: analyserDiv
  }), keys(props.fx).length > 0 && /*#__PURE__*/React.createElement("button", {
    className: classnames(style$3.button, props.isEffectsDisabled && style$3.isPressed),
    onClick: () => props.onBypass(props.id)
  }, "Bypass FX"), /*#__PURE__*/React.createElement("div", {
  ...
  }), !props.hasSolo && /*#__PURE__*/React.createElement("button", {
    className: classnames(style$3.button, props.isMuted && style$3.isPressed),
    onClick: () => {
      setSoloMutePriorityHelper('m');
      props.onMute(props.id);
    }
  }, "M")), /*#__PURE__*/React.createElement(Knob, {
    min: 0,
    max: 100,
    value: props.pan,
    onChange: value => props.onPanChange(props.id, value)
  }), keys(props.fx).length > 0 && /*#__PURE__*/React.createElement("div", {
    className: style$3.sends
  }, keys(props.fx).map(sendId => /*#__PURE__*/React.createElement("div", {
    className: style$3.send,
    key: sendId
  }, /*#__PURE__*/React.createElement("span", {
    className: style$3.sendTitle
  }, sendId), /*#__PURE__*/React.createElement(Fader, {
...
const Tracks = () => {
    ...
    try {
      function _temp2() {
        setTracks(tracks => tracks.map(track => {
          if (track.id === trackId) {
            onUserInput({
              type: UserInputEvents.playingStateChange,
    ...
    try {
      function _temp8() {
        setTracks(tracks => tracks.map(track => {
          if (track.id === trackId) {
            onUserInput({
              type: UserInputEvents.trackVolumeChange,
              value: value,
              trackId: track.id
            });
            return { ...track,
    ...
    try {
      function _temp12() {
        setTracks(tracks => tracks.map(track => {
          if (track.id === trackId) {
            onUserInput({
              type: UserInputEvents.panChange,
              value: value,
              trackId: track.id
            });
            return { ...track,
  ...
  }, isReady && tracks.map((track, index) => /*#__PURE__*/React.createElement(Track$1, Object.assign({
    key: track.id + index
  }, track, {
    hasSolo: hasSolo,
...
const MasterTrackContainer = ({
  ...
  const masterVolume = useRecoilValue(masterVolumeState);
  return /*#__PURE__*/React.createElement(MasterTrack, {
    volume: masterVolume,
...
const Effects = () => {
  ...
  }, effects.map(effect => /*#__PURE__*/React.createElement(EffectContainer, Object.assign({}, effect, {
    key: effect.id
  }))));
};
...
const Desk = ({
  ...
  const [isControlsContainerFixed, setIsControlsContainerFixed] = useState(false);
  const deskDiv = useRef();
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    fill: '#fff',
    d: 'M24.254 25V11.368h5.729V25z'
  }))))), "Audio Mixer"), /*#__PURE__*/React.createElement("p", null, "Create your own mix to practice along with")), /*#__PURE__*/React.createElement(Tracks, null), analyser && /*#__PURE__*/React.createElement(MasterTrackContainer, {
  ...
  }, /*#__PURE__*/React.createElement(ProgressBar$1, null), /*#__PURE__*/React.createElement("div", {
...
export { CONTEXT_STATE, Context, Delay, DeskContainer, Distortion, EffectContainer, FILTER_TYPES, FX, Mixdesk, Mixer, MxContext, MxContextProvider, PLAYBACK_STATUS, Reverb, TRACK_STATE, UserInputEvents, connectNodes, connectNodesSingle, createAnalyser, createContext, createEffectEntity, createGainNode, createMasterBus, createPanner, createPlaybackEntity, createState, createTrackEntity, fetchAudioAsArrayBuffer, generateIdByTitle, getNodeParamNormalizedValue, isActive, isAudioParam, isContextRunning, isNotActive, isPaused, isPlaying, isReady, pauseAll, playAll, resumeContext, rewindAll, setNodeParamNormalizedValue, setNodeParams, stopAll, useMixer, useMxContext, useProgress, useScrollPosition };
